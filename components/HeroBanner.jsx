    ...
    <div className="relative text-white text-[20px] w-full max-w-[1360px] mx-auto ">
        ...
        renderArrowNext={(clickHandler, hasNext) => (
          <div
            ...
            className="absolute right-0 bottom-0 w-[30px]
             md:w-[50px] h-[30px] md:h-[50px] bg-black 
             z-10 flex items-center justify-center cursor-pointer
              hover:opacity-90"
          >
      ...
      >
        <div>
          ...
          <div
            className="px-[15px] 
          md:px-[40px] py-[10px] md:py-[25px]
           font-oswald bg-white absolute bottom-[25px] 
           md:bottom-[75px] text-black/[0.9] text-[15px] 
